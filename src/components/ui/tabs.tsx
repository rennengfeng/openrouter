  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        'data-active:bg-background data-active:text-foreground dark:data-active:border-purple-500/30 dark:data-active:bg-gradient-to-r dark:data-active:from-purple-600/80 dark:data-active:to-indigo-600/80 dark:data-active:text-white',
